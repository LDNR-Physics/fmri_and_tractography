...
matlabbatch{4}.spm.tools.fieldmap.calculatevdm.subj.defaults.defaultsval.et = '<UNDEFINED>';
matlabbatch{4}.spm.tools.fieldmap.calculatevdm.subj.defaults.defaultsval.maskbrain = 1;
matlabbatch{4}.spm.tools.fieldmap.calculatevdm.subj.defaults.defaultsval.blipdir = '<UNDEFINED>';
matlabbatch{4}.spm.tools.fieldmap.calculatevdm.subj.defaults.defaultsval.tert = '<UNDEFINED>';
...
matlabbatch{14}.spm.stats.fmri_spec.timing.RT = '<UNDEFINED>';
...
matlabbatch{14}.spm.stats.fmri_spec.sess.cond.name = '<UNDEFINED>';
matlabbatch{14}.spm.stats.fmri_spec.sess.cond.onset = '<UNDEFINED>';
matlabbatch{14}.spm.stats.fmri_spec.sess.cond.duration = '<UNDEFINED>';
...
matlabbatch{16}.spm.stats.con.consess{1}.tcon.name = '<UNDEFINED>';
