...
expName = 'lips'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\swastlin\\Desktop\\fmri_paradigms\\lips\\lips.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    instructions_wait_for_manual_trigger = visual.ImageStim(
        ...
        image='resources/instructions_lips.png', mask=None, anchor='center',
    ...
    rest = visual.ImageStim(
        ...
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=0.0)
    task = visual.ImageStim(
        win=win,
        name='task', units='height', 
    ...
    for thisBlock in blocks:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        task.setImage('resources/lips.png')
        ...
        if rest_task.maxDurationReached:
            routineTimer.addTime(-rest_task.maxDuration)
        elif rest_task.forceEnded:
            routineTimer.reset()
        else:
