...
operator_dialog_a.addField('Side:', choices=['Left', 'Right', 'Both'], tip="Select which foot to test.")
...
expName = 'feet'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\swastlin\\Desktop\\fmri_paradigms\\feet\\feet.py',
